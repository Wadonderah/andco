...
class SchoolAdminAuthScreen extends ConsumerStatefulWidget {
  const SchoolAdminAuthScreen({super.key});

  @override
  ConsumerState<SchoolAdminAuthScreen> createState() =>
      _SchoolAdminAuthScreenState();
}

class _SchoolAdminAuthScreenState extends ConsumerState<SchoolAdminAuthScreen>
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Manage your school\'s transport operations',
          ...
          children: [
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: Text(
                  'Forgot Password?',
                  style: TextStyle(color: AppColors.schoolAdminColor),
                ),
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextField(
              ...
              hint: 'Enter school identification code',
            ...
            CustomTextField(
              ...
              hint: 'e.g., Principal, Vice Principal, Admin',
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  ...
                  const TextSpan(
                      text:
                          ', and confirm I have authority to manage school transport'),
                ],
              ),
            ),
          ),
      ...
      try {
        ...
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
                builder: (context) => const SchoolAdminDashboard()),
          );
        }
      } catch (e) {
        if (mounted) {
  ...
  void _signInWithGoogle() async {
    try {
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => const SchoolAdminDashboard()),
        );
      }
    } catch (e) {
      if (mounted) {
